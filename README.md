...
```sh
pip install git+https://github.com/SSaeedHoseini/marzapi.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/SSaeedHoseini/marzapi.git`)
